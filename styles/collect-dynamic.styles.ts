...
import { AppColorTokens, AppSpacing } from "@/constants/theme";

export function makeCollectDynamicStyles(colors: AppColorTokens) {
...
export const collectDynamicStyles = makeCollectDynamicStyles;
