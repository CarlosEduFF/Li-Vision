...
export function makeLearnStyles(colors: AppColorTokens) {
  ...
  moduleBtnText: { color: colors.text.muted, fontSize: 14, fontWeight: "700" },
  ...
  adminBtnText: { color: colors.background, fontWeight: "800", fontSize: 14 },
  levelSection: {
    backgroundColor: colors.surface,
  ...
  badgeText: { color: colors.text.muted, fontSize: 10, fontWeight: "800" },
  progressRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "flex-end",
  ...
  progressDetail: { color: colors.text.muted, fontSize: 12, fontWeight: "600", marginBottom: 2 },
  iconCircle: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  categoryCount: { color: colors.text.muted, fontSize: 12, marginTop: 2 },
  playBtn: {
    width: 32,
    height: 32,
